...
const ThemePanel: React.FC<ThemePanelProps> = ({ visible, onExportPDF, showGrid, onToggleGrid }) => {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    img.onload = () => {
      ...
      // Calculate relative luminance to guarantee text contrast
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <select 
          onChange={(e) => {
            ...
            if (t) setTheme({ id: t.id, name: t.name, backgroundColor: t.bg, textColor: t.text, accentColor: t.accent, fontFamily: t.font });
            e.target.value = ""; 
          }}
          ...
          defaultValue=""
        >
          <option value="" disabled>Designer Presets...</option>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', padding: '16px', backgroundColor: `${theme.textColor}05`, borderRadius: '16px', border: `1px solid ${theme.textColor}0A` }}>
          <label style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <input 
              ...
              style={{ width: '28px', height: '28px', border: 'none', padding: 0, cursor: 'pointer', backgroundColor: 'transparent' }}
            />
          </label>
